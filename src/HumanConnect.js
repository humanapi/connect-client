((window, undefined) => {
    const onMessageReceived = event => {
        ...
        if (response.type === "hapi-connect-close") {
            ...
            if (HumanConnect.onClose) {
                HumanConnect.onClose(response);
            }
        }
        if (response.type === "hapi-connect-error") {
            if (HumanConnect.onError) {
                HumanConnect.onError(response.error);
            }
        }
    };
    ...
    HumanConnect.open = (options = {}) => {
        ...
        HumanConnect.onFinish = options.finish;
        HumanConnect.onClose = options.close;
        HumanConnect.onError = options.error;
    ...
    window.HumanConnect = HumanConnect;
})(this);
