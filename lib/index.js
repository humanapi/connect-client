...
function load(options) {
    ...
    if (!options.token && tokenRequired) throw new Error("The token attribute is required");
    ...
    function buildIFrame() {
        ...
        target.title = "Connect - Powered by Human API";
        target.id = "human-api";
...
function open(options = {}) {
    ...
    function focusIframe(iframe) {
        ...
        // Default templates do not have footer outside div#app
        // Certain customized templates have footercv outside of div#app
        const footer = document.getElementById("footer"); 
        app.blur();
